...
<div class="w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-6 sm:mb-8">
            <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800">Form Pengajuan Surat PKL</h1>
            <p class="text-sm sm:text-base text-gray-500 mt-1.5">Isi formulir untuk mengajukan izin praktik kerja lapangan.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-5 sm:p-8">
            ...
            <form action="{{ route('pengajuan.pkl.store') }}" method="POST" class="space-y-4 sm:space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1.5">Tanggal Mulai PKL</label>
                        <input type="date" name="tanggal_mulai" required
                            class="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg text-sm sm:text-base focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1.5">Tanggal Selesai PKL</label>
                ...
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-1.5">Tempat PKL</label>
                    <input type="text" name="tempat_pkl" required placeholder="Masukkan nama instansi / perusahaan"
                        class="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg text-sm sm:text-base focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                </div>

                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-1.5">Alamat Tempat PKL</label>
                ...
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-1.5">Tujuan Surat (Jabatan)</label>
                ...
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-1.5">Pembimbing PKL</label>
                    <select name="pembimbing_pkl" required
                ...
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-1.5">Nomor HP Dosen Pembimbing</label>
