    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-6 sm:mb-8">
            <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800">
                Form Pengajuan Surat Penelitian
            </h1>

            <p class="text-sm sm:text-base text-gray-500 mt-2">
                Isi formulir untuk mengajukan izin penelitian Tugas Akhir / Skripsi.
            </p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-5 sm:p-8">
            ...
            <form action="{{ route('pengajuan.penelitian.store') }}"
                method="POST"
                ...
                <div>
                    ...
                    <input type="text"
                        placeholder="/E/PHS-SB/TI/ (Akan diisi oleh Admin)"
                        disabled
                ...
                <div>
                    ...
                    <textarea name="alamat_tempat_penelitian"
                        rows="3"
                        required
                ...
                <div>
                    ...
                    <input type="text"
                        name="tujuan_surat"
                        required
                        placeholder="Direktur, Kepala Dinas, Manager, dll"
                        class="w-full px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg text-sm sm:text-base focus:ring-blue-500 focus:border-blue-500 outline-none">
                </div>
                ...
                <div>
                    ...
                    <input type="text"
                        name="judul_ta"
                        required
                        placeholder="Masukkan judul tugas akhir / skripsi"
                        class="w-full px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg text-sm sm:text-base focus:ring-blue-500 focus:border-blue-500 outline-none">
                </div>
