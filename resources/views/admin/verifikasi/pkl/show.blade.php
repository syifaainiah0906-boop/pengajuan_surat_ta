    ...
    Diajukan pada {{ \Carbon\Carbon::parse($pkl->tanggal_pengajuan)->translatedFormat('d F Y, H:i') }}
</p>
                    </div>
                    <div>
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="col-span-2 md:col-span-1">
                        <h3 class="text-lg font-semibold text-gray-400 uppercase tracking-wider mb-4">Informasi Mahasiswa</h3>
                        <div class="space-y-4">
                            <div>
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="text-sm text-gray-500">Tempat PKL</label>
                ...
                <div class="bg-gray-50 px-8 py-6 border-t border-gray-200 text-center">
                    <p class="text-gray-500 italic">Pengajuan ini telah diproses pada {{ $pkl->updated_at->setTimezone('Asia/Makassar')->translatedFormat('d F Y, H:i') }}</p>
                @endif
