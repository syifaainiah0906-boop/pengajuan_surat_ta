    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-xs sm:text-sm mt-1">
                        Diajukan pada
                        {{ \Carbon\Carbon::parse($pkl->tanggal_pengajuan)->translatedFormat('d F Y, H:i') }}
                    </p>
                </div>
        ...
        <div class="p-5 sm:p-8 grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div>
                ...
                <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3 sm:mb-4">
                    Informasi Mahasiswa
                </h3>
                ...
                <div class="space-y-3 sm:space-y-4">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-800 text-base sm:text-lg">
                            {{ $pkl->user->name }}
                        </p>
                    </div>
            ...
            <div>
                ...
                <div class="space-y-3 sm:space-y-4">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-800 text-sm sm:text-base leading-relaxed">
            ...
            <div class="col-span-1 md:col-span-2 border-t border-gray-100 pt-5 sm:pt-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-800 text-sm sm:text-base mt-1">
                            {{ $pkl->pembimbing_pkl }}
                        </p>
                    </div>
