...
<div class="w-full px-4 sm:px-6 lg:px-10 py-6 sm:py-8">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 mb-3">
        ...
        <form method="GET"
              action="{{ route('admin.verifikasi.penelitian.index') }}"
                ...
                <div class="flex flex-col items-end gap-1.5 flex-shrink-0">
                    ...
                    @if($item->status == 'pending')
                        ...
                        <div class="flex gap-1">
                            ...
                            <form action="{{ route('admin.verifikasi.penelitian.update', $item->id) }}"
                                  method="POST"
                ...
                <tbody class="text-gray-700">
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-50 transition">
                        ...
                        <td class="py-4 px-6 text-sm">
                            {{ $index + 1 + ($data_penelitian->currentPage() - 1) * $data_penelitian->perPage() }}
                        </td>
