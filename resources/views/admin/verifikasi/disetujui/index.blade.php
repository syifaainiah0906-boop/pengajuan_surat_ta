...
<div class="w-full px-4 sm:px-6 lg:px-10 py-6 sm:py-8">
    ...
    <div class="mb-5 sm:mb-6">
        ...
        <p class="text-gray-500 text-sm mt-1">
            Data pengajuan surat yang telah disetujui
        </p>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 mb-4">
        ...
        <form method="GET"
              action="{{ route('admin.verifikasi.disetujui.index') }}"
        ...
        <div class="flex items-start justify-between gap-3 px-4 py-3 border-b border-gray-50 last:border-none">
            ...
            <div class="min-w-0">
                ...
                <div class="flex items-center gap-2 mt-2">
                    ...
                    <span class="bg-green-100 text-green-800 px-2.5 py-1 rounded-full text-[11px] font-bold">
                        Disetujui
                    </span>
